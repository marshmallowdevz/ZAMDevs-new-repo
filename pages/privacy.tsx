...
const PrivacyPolicy = () => (
  <main style={{ padding: "2rem", maxWidth: 800, margin: "0 auto" }}>
    ...
    <h2>Cookies</h2>
    <p>
      Cookies are files with a small amount of data which may include an anonymous unique identifier. We use cookies to collect information to improve our services.
    </p>
    <h2>Security</h2>
    <p>
