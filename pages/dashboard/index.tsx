            ...
            <div className="rounded-2xl shadow-xl p-6 flex flex-col items-center bg-gradient-to-br from-[#E1D8E9]/80 to-[#B6A6CA]/80 border border-white/40">
              ...
              <div className="w-20 h-20 mb-4">
                <svg viewBox="0 0 40 40">
                  ...
                  <path d="M20 2 a18 18 0 1 1 0 36" stroke="#a78bfa" strokeWidth="4" fill="none" />
                </svg>
              </div>
              <button onClick={handleViewTrends} className="bg-gradient-to-r from-[#A09ABC] to-[#B6A6CA] text-white px-5 py-2 rounded-lg font-bold shadow hover:from-[#B6A6CA] hover:to-[#A09ABC] transition">
                View Trends
              </button>
            </div>
            {/* Quick Entry */}
